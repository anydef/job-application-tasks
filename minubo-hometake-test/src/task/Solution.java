...
public class Solution {
    ...
    /**
     * This task deals with string manipulation using the example of task.IPv6
     ...
     * <p>
     * Format of an task.IPv6 address: 8 hexadecimal numbers separated by colons.
     * <p>
     * For convenience, an task.IPv6 address may be simplified to shorter notations
     ...
     * as 2001:db8:0:0:1::1.
     * <p>
     * IMPORTANT: If you choose to use regular expressions, please make sure not to overuse it.
     */

    // Test examples - a map of full task.IPv6 addresses and their simplified representation
    ...
    public static class IPv6Address {
        ...
        public String getSimplifiedRepresentation() {
            ...
            // Rules for simplifying task.IPv6 addresses:
